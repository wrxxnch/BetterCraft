...
core.register_node("mcl_core:podzol", {
	...
	groups = {handy=1, shovely=1, dirt=2, soil=1, soil_sapling=2, soil_sugarcane=1, soil_bamboo = 1, soil_fungus=1, enderman_takable=1, building_block=1, supports_mushrooms=1, converts_to_moss=1},
	drop = "mcl_core:dirt",
	sounds = mcl_sounds.node_sound_dirt_defaults(),
	on_construct = mcl_core.on_snowable_construct,
	_on_shovel_place = mcl_core.make_dirtpath,
...
core.register_node("mcl_core:ironblock", {
	...
	is_ground_content = false,
	groups = {pickaxey = 2, building_block = 1, beacon_block = 1},
...
core.register_node("mcl_core:goldblock", {
	...
	is_ground_content = false,
	groups = {pickaxey=4, building_block=1, piglin_protected=1, beacon_block = 1},
	sounds = mcl_sounds.node_sound_metal_defaults(),
	_mcl_blast_resistance = 6,
	_mcl_hardness = 3,
