...
if minetest.get_modpath("3d_armor") then
	armor:register_armor("ruby:helmet_ruby", {
		...
		groups = {armor_head=1, armor_heal=16, armor_use=0},
	...
	armor:register_armor("ruby:leggings_ruby", {
		...
		groups = {armor_legs=1, armor_heal=16, armor_use=0},
	...
	armor:register_armor("ruby:chestplate_ruby", {
		...
		groups = {armor_torso=1, armor_heal=16, armor_use=0},
		armor_groups = {fleshy=30},
		damage_groups = {cracky=2, snappy=1, level=6},
	})
		...
		groups = {armor_feet=1, armor_heal=16, armor_use=0, physics_jump=0.5},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=2, snappy=1, level=6},
	})
		...
		armor:register_armor("ruby:shield_ruby", {
			...
			groups = {armor_shield=1, armor_heal=12, armor_use=0},
			armor_groups = {fleshy=10},
			damage_groups = {cracky=2, snappy=1, level=6},
	})
